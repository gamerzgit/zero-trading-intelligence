...
-- ============================================================================
-- 9. EXECUTION LOG (Milestone 6 - Trade Execution History)
-- ============================================================================
...
CREATE INDEX idx_execution_log_time ON execution_log (time);
...
CREATE INDEX idx_execution_log_time_ticker ON execution_log (time, ticker);
